module.exports = {
  TOKEN:
    "MTA4Mzc2NDUyMDgxMzYxMzA1Ng.Gf7rVM.lVLFSFlqfe_H6cfOoyZK2TC2NoN3V8oZU0bHGc",
  ownerID: [""], //write your discord user id. example: ["id"] or ["id1","id2"]
  botInvite:
    "https://discord.com/oauth2/authorize?client_id=1083764520813613056&scope=bot&permissions=8", //write your discord bot invite.
  supportServer: "", //write your discord bot support server invite.
  mongodbURL: "mongodb+srv://zacky0204:zacky0204@cluster0.hvclvxh.mongodb.net", //write your mongodb url.
  status: "Made With ❤️ by Z",
